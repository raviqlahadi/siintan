...
class Status extends Admin_Controller {
    ...
    private $current_page = 'setting/status';
    ...
    public function index(){
        ...
        $tabel_cell =  ['id','name','description','color'];
       ...
       //fetch data from database
        $fetch['select'] = ['id','name','description','color'];
        ...
        $this->render( "setting/status/content");
    }
    ...
    public function create(){
      ...
      $this->render( "setting/status/create");
    }
    ...
    public function edit($id=null){
      ...
      $this->render( "setting/status/edit");
    }
    ...
    public function detail($id=null){
      ...
      $this->render("setting/status/detail");
    }
    ...
    private function label(){
      $name = $this->name;
      $label = [
        "id", "Nama Status", "Keterangan", "Warna"
      ];
      $label_arr = array();
