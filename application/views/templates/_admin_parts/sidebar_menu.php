...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        <!-- User Info -->
        <div class="user-info" style="background: url(<?php echo base_url('assets/') ?>img/user-img-background-<?php echo APP_COLOR ?>.jpg) no-repeat no-repeat;">
            <div class="image">
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2019 <a href="javascript:void(0);">SiIntan - Techno's Studio</a>.
            </div>
            <div class="version">
                <b>Version: </b> 0.1
            </div>
